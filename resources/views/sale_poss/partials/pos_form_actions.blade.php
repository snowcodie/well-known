...
<div class="row">
	<div class="pos-form-actions">
		<div class="col-md-12">
			...
			@if(!Gate::check('disable_draft') || auth()->user()->can('superadmin'))
			...
			@endif
			@if(!Gate::check('disable_quotation') || auth()->user()->can('superadmin'))
			...
			@endif
			@if(!Gate::check('disable_suspend_sale') || auth()->user()->can('superadmin'))
			...
			@if(!Gate::check('disable_credit_sale') || auth()->user()->can('superadmin'))
				...
				@endif
			@endif
			@if(!Gate::check('disable_card') || auth()->user()->can('superadmin'))
				<button type="button" 
			...
			@if(!Gate::check('disable_pay_checkout') || auth()->user()->can('superadmin'))
